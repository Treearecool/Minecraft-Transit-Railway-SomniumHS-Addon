...
import mtr.render.RouteRenderer;
...
public class RenderPIDSSHSRoute<T extends BlockRouteSignBase.TileEntityRouteSignBase> extends BlockEntityRendererMapper<T> implements IBlock, IGui {

    private static final int SCALE = 480;

    public RenderPIDSSHSRoute(BlockEntityRenderDispatcher dispatcher) {
        super(dispatcher);
    }
