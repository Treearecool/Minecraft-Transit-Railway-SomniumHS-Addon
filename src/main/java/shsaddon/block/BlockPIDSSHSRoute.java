...
public class BlockPIDSSHSRoute extends BlockPIDSSHSBase {
    ...
    public BlockEntity createBlockEntity(BlockView world) {
        return new TileEntityBlockPIDSSHSRoute();
    }
    ...
    public static class TileEntityBlockPIDSSHSRoute extends BlockEntity {

        public TileEntityBlockPIDSSHSRoute() {
            super(SHSAddon.PIDS_SHS_ROUTE_TILE_ENTITY);
        }
    }
}
